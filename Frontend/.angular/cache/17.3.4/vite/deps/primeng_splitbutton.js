import {
  AngleRightIcon
} from "./chunk-GYSPYYBE.js";
import {
  ChevronDownIcon,
  Tooltip,
  TooltipModule
} from "./chunk-624A7KG5.js";
import {
  RouterLink,
  RouterLinkActive,
  RouterModule
} from "./chunk-A5ARSSGZ.js";
import "./chunk-I5KCAP2K.js";
...
import {
  ButtonDirective,
  ButtonModule
} from "./chunk-OSPUMX6U.js";
import {
  Ripple,
  RippleModule
} from "./chunk-QAF5OMBM.js";
import "./chunk-E7W64ORZ.js";
import {
  ObjectUtils,
  OverlayService,
  PrimeNGConfig,
  ...
  UniqueComponentId,
  zindexutils
} from "./chunk-W4VHX4KA.js";
import {
  AutoFocus,
  AutoFocusModule,
  ConnectedOverlayScrollHandler,
  DomHandler
} from "./chunk-KEZ7BEZB.js";
import {
  CommonModule,
  DOCUMENT,
  NgClass,
...
function TieredMenuSub_ng_template_2_li_1_ng_container_3_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainerStart(0);
    ɵɵtemplate(1, TieredMenuSub_ng_template_2_li_1_ng_container_3_a_1_Template, 7, 14, "a", 12)(2, TieredMenuSub_ng_template_2_li_1_ng_container_3_a_2_Template, 7, 24, "a", 13);
    ɵɵelementContainerEnd();
  }
  if (rf & 2) {
...
function SplitButton_ng_container_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r2 = ɵɵnextContext();
    ɵɵadvance();
    ɵɵproperty("severity", ctx_r2.severity)("text", ctx_r2.text)("outlined", ctx_r2.outlined)("size", ctx_r2.size)("icon", ctx_r2.icon)("iconPos", ctx_r2.iconPos)("disabled", ctx_r2.disabled)("autofocus", ctx_r2.autofocus);
    ɵɵattribute("tabindex", ctx_r2.tabindex)("aria-label", (ctx_r2.buttonProps == null ? null : ctx_r2.buttonProps["aria-label"]) || ctx_r2.label);
    ɵɵadvance();
...
function SplitButton_ng_template_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r2 = ɵɵnextContext();
    ɵɵproperty("severity", ctx_r2.severity)("text", ctx_r2.text)("outlined", ctx_r2.outlined)("size", ctx_r2.size)("icon", ctx_r2.icon)("iconPos", ctx_r2.iconPos)("label", ctx_r2.label)("disabled", ctx_r2.buttonDisabled)("autofocus", ctx_r2.autofocus);
...
var SplitButton = class _SplitButton {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    decls: 10,
    vars: 26,
    consts: [["container", ""], ["defaultButton", ""], ["menu", ""], ["defaultbtn", ""], [3, "ngClass", "ngStyle"], [4, "ngIf", "ngIfElse"], ["type", "button", "pButton", "", 1, "p-splitbutton-menubutton", "p-button-icon-only", 3, "click", "keydown", "size", "severity", "text", "outlined", "disabled"], [4, "ngIf"], [4, "ngTemplateOutlet"], [3, "id", "popup", "model", "styleClass", "appendTo", "showTransitionOptions", "hideTransitionOptions"], ["type", "button", "pButton", "", "pAutoFocus", "", 1, "p-splitbutton-defaultbutton", 3, "click", "severity", "text", "outlined", "size", "icon", "iconPos", "disabled", "autofocus"], ["type", "button", "pButton", "", "pAutoFocus", "", 1, "p-splitbutton-defaultbutton", 3, "click", "severity", "text", "outlined", "size", "icon", "iconPos", "label", "disabled", "autofocus"]],
    template: function SplitButton_Template(rf, ctx) {
      if (rf & 1) {
        const _r1 = ɵɵgetCurrentView();
        ɵɵelementStart(0, "div", 4, 0);
        ɵɵtemplate(2, SplitButton_ng_container_2_Template, 3, 11, "ng-container", 5)(3, SplitButton_ng_template_3_Template, 2, 11, "ng-template", null, 1, ɵɵtemplateRefExtractor);
    ...
    dependencies: () => [NgClass, NgIf, NgTemplateOutlet, NgStyle, ButtonDirective, TieredMenu, AutoFocus, ChevronDownIcon],
