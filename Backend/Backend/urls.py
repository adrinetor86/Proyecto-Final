...
from Backend.views import (games, game, login, register, child_comments, confirm_exist_user, confirm_code, change_password,
                           ...
                           insert_map, get_maps, get_filters, edit_game, delete_game, send_warn_email)
...
urlpatterns = [
    ...
    path('edit_game/', edit_game, name='edit_game'),
    path('insertar_guarro/', portada, name='portada'),
    path('insert_comment/<id_game>/', insert_comment, name='insert_comment_father'),
    path('insert_comment/<id_game>/<father_comment>/', insert_comment, name='insert_comment'),
